...
intolambda.form_utils.build_textarea = (function intolambda$form_utils$build_textarea(p__10528){
var map__10531 = p__10528;
var map__10531__$1 = ((((!((map__10531 == null)))?((((map__10531.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10531.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10531):map__10531);
var field_name = cljs.core.get.call(null,map__10531__$1,new cljs.core.Keyword(null,"field-name","field-name",1300687948));
var field_type = cljs.core.get.call(null,map__10531__$1,new cljs.core.Keyword(null,"field-type","field-type",2075623493));
var pattern = cljs.core.get.call(null,map__10531__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var err_msg = cljs.core.get.call(null,map__10531__$1,new cljs.core.Keyword(null,"err-msg","err-msg",-1158512684));
...
intolambda.form_utils.build_textfield = (function intolambda$form_utils$build_textfield(p__10533){
var map__10536 = p__10533;
...
var field_name = cljs.core.get.call(null,map__10536__$1,new cljs.core.Keyword(null,"field-name","field-name",1300687948));
var field_type = cljs.core.get.call(null,map__10536__$1,new cljs.core.Keyword(null,"field-type","field-type",2075623493));
var pattern = cljs.core.get.call(null,map__10536__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var err_msg = cljs.core.get.call(null,map__10536__$1,new cljs.core.Keyword(null,"err-msg","err-msg",-1158512684));
...
return intolambda.form_utils.build_textfield.call(null,p1__10538_SHARP_);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.page-content.center-component","div.page-content.center-component",-990022664),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.content-grid.mdl-grid.mdl-js-grid","div.content-grid.mdl-grid.mdl-js-grid",-1368125107),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mdl-cell.mdl-cell--4-col..mdl-cell--4-col-tablet.mdl-cell--2-col-phone","div.mdl-cell.mdl-cell--4-col..mdl-cell--4-col-tablet.mdl-cell--2-col-phone",591437785),new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),form_params,cljs.core.map.call(null,(function (p1__10539_SHARP_){
return intolambda.form_utils.build_field.call(null,p1__10539_SHARP_);
