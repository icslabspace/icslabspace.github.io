...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7071__auto__,k12774,else__7072__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k12774,else__7072__auto__);
...
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$was_DASH_aborted,null,cljs.core.cst$kw$status_DASH_text,null,cljs.core.cst$kw$headers,null,cljs.core.cst$kw$status,null,cljs.core.cst$kw$body,null], null), null),k__7079__auto__)){
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7076__auto__,k__7077__auto__,G__12773){
var self__ = this;
var this__7076__auto____$1 = this;
var pred__12777 = cljs.core.keyword_identical_QMARK_;
var expr__12778 = k__7077__auto__;
if(cljs.core.truth_((pred__12777.cljs$core$IFn$_invoke$arity$2 ? pred__12777.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$status,expr__12778) : pred__12777.call(null,cljs.core.cst$kw$status,expr__12778)))){
return (new ajax.protocols.Response(G__12773,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12777.cljs$core$IFn$_invoke$arity$2 ? pred__12777.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$body,expr__12778) : pred__12777.call(null,cljs.core.cst$kw$body,expr__12778)))){
return (new ajax.protocols.Response(self__.status,G__12773,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12777.cljs$core$IFn$_invoke$arity$2 ? pred__12777.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$status_DASH_text,expr__12778) : pred__12777.call(null,cljs.core.cst$kw$status_DASH_text,expr__12778)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__12773,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12777.cljs$core$IFn$_invoke$arity$2 ? pred__12777.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$headers,expr__12778) : pred__12777.call(null,cljs.core.cst$kw$headers,expr__12778)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__12773,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12777.cljs$core$IFn$_invoke$arity$2 ? pred__12777.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$was_DASH_aborted,expr__12778) : pred__12777.call(null,cljs.core.cst$kw$was_DASH_aborted,expr__12778)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__12773,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__7077__auto__,G__12773),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7068__auto__,G__12773){
var self__ = this;
var this__7068__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__12773,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__12775){
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__12775),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__12775),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__12775),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__12775),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__12775),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__12775,cljs.core.cst$kw$status,cljs.core.array_seq([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0)),null));
});
