...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__9532,opts){
var map__9533 = p__9532;
var map__9533__$1 = ((((!((map__9533 == null)))?((((map__9533.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9533.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9533):map__9533);
var files = cljs.core.get.call(null,map__9533__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
args__7520__auto__.push((arguments[i__7514__auto___9540]));
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__9537){
var vec__9538 = p__9537;
var opts = cljs.core.nth.call(null,vec__9538,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__9538,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__9538,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__9538,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__9538,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq9535){
var G__9536 = cljs.core.first.call(null,seq9535);
var seq9535__$1 = cljs.core.next.call(null,seq9535);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__9536,seq9535__$1);
});
