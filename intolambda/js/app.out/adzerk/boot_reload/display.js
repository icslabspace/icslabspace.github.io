...
var attr = cljs.core.nth.call(null,vec__9076,(0),null);
...
var args9077 = [];
var len__7513__auto___9080 = arguments.length;
var i__7514__auto___9081 = (0);
while(true){
if((i__7514__auto___9081 < len__7513__auto___9080)){
args9077.push((arguments[i__7514__auto___9081]));

var G__9082 = (i__7514__auto___9081 + (1));
i__7514__auto___9081 = G__9082;
continue;
} else {
}
break;
...
var len__7513__auto___9085 = arguments.length;
var i__7514__auto___9086 = (0);
while(true){
if((i__7514__auto___9086 < len__7513__auto___9085)){
args__7520__auto__.push((arguments[i__7514__auto___9086]));

var G__9087 = (i__7514__auto___9086 + (1));
i__7514__auto___9086 = G__9087;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9084){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9084));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9088){
var map__9092 = p__9088;
...
var data = map__9092__$1;
var message = cljs.core.get.call(null,map__9092__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9092__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9092__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9094 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9094,goog.events.EventType.CLICK,((function (G__9094,map__9092,map__9092__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9094,map__9092,map__9092__$1,data,message,line,file))
);

return G__9094;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9095){
var map__9099 = p__9095;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9102){
var map__9106 = p__9102;
...
var messages = map__9106__$1;
var warnings = cljs.core.get.call(null,map__9106__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9106__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9108 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9108,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9108,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9109){
var map__9112 = p__9109;
var map__9112__$1 = ((((!((map__9112 == null)))?((((map__9112.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9112.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9112):map__9112);
var messages = map__9112__$1;
var warnings = cljs.core.get.call(null,map__9112__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9112__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9112,map__9112__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9112,map__9112__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9112,map__9112__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9112,map__9112__$1,messages,warnings,exception))
;
